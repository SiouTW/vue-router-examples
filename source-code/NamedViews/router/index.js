...
import NamedViews from "@/components/NamedViews.vue";
import NVT from "@/components/nv&nr/NVT.vue";
import NVM from "@/components/nv&nr/NVM.vue";
import NVD from "@/components/nv&nr/NVD.vue";
const routes = [
  {
    path: "/",
    name: "Nestedroutes",
...

  {
    ...
    children: [
      ...
      {
        path: "/nv",
        redirect: { name: "NVExample" },
      },
      {
        path: "/pn/stringrouter",
        component: StringRouter,
        name: "StringRouter",
        alias: "nva",
      },
